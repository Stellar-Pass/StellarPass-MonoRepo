-- Stellar Pass — Database initialization script
-- Run this to set up the database schema

-- Create database if not exists (run as superuser)
-- CREATE DATABASE stellar_pass;

-- Connect to stellar_pass database
\c stellar_pass;
...
-- ============================================================
-- INSERT INTO organizers (stellar_account, name, email)
-- VALUES ('GXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', 'Demo Organizer', 'demo@stellarpass.io');
